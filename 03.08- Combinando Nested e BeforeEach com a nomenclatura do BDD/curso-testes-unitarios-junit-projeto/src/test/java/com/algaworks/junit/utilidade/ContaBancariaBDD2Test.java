...
class ContaBancariaBDD2Test {
     ...
     */
        ...
        void saqueComSucesso() {
            ...
            BigDecimal saldoEmConta = BigDecimal.valueOf(50);
            BigDecimal valorASerSacadoDaConta = BigDecimal.valueOf(25);

            ContaBancaria contaBancaria = new ContaBancaria(saldoEmConta);
            contaBancaria.saque(valorASerSacadoDaConta);
     ...
     */
        ...
        void saqueValorNuloTest() {
            ...
            Executable valorNulo = () -> contaBancaria.saque(null);
            IllegalArgumentException illegalArgumentException = assertThrows(IllegalArgumentException.class,valorNulo);
     ...
     */
        ...
        void saqueValorIgualAZeroTest() {
            ...
            Executable chamdaAoMetodoComValorDeSaqueIgualAZero = () -> contaBancaria.saque(BigDecimal.ZERO);
            IllegalArgumentException illegalArgumentException =
                    assertThrows(IllegalArgumentException.class,chamdaAoMetodoComValorDeSaqueIgualAZero);
